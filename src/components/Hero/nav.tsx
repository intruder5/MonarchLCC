...
export default function Nav() {
    ...
    return (
        <header className="bg-white max-w-8xl mx-auto border sticky top-0 z-50 border-gray-300">
            <div className="px-6 sm:px-8 lg:px-10">
                <div className="flex justify-between items-center h-16 md:h-18">

                    {/* Logo */}
                    <Link href="/" className="flex-shrink-0 size-25 rounded-full mt-9 cursor-pointer">
                    ...
                    <div className="px-6 pt-6 pb-10 space-y-3">
                        ...
                        <div className="pt-6 px-2">
                            <Link
                                href="/apply"
                                className="
                                    block text-center w-full bg-orange-600 hover:bg-orange-700
