        ...
        <main className="bg-white">
            ...
            <section className="max-w-3xl mx-auto px-6 py-16 space-y-12">
                            ...
                            <div className="space-y-3 mb-6">
                                {s.docs.map((doc) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-gray-800 font-medium text-base group-hover:text-orange-600 transition-colors flex-1">
                                            {doc.label}
                                        </span>
                            ...
                            <div key={i} className="bg-gray-50 border border-gray-200 rounded-2xl p-6 mb-4">
                                ...
                                {notice.nrs ? (
                                    <div className="space-y-3 text-gray-600 text-sm leading-relaxed">
                                        ...
                                        <p>
                                            A licensee who has been issued a license to operate a high-interest loan
                                            service shall place the following notices on marketing materials and
                                            advertising when space or time reasonably permits:
                                        </p>
                                ...
                                {notice.phone && (
                                    <p className="text-gray-500 text-sm mt-1">
                                        Phone:{' '}
                                        <a href={`tel:${notice.phone}`} className="text-orange-600 hover:underline">
                                            {notice.phone}
                                        </a>
                                    </p>
                                )}
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-2xl p-6">
                    ...
                    <a href="tel:8006662742" className="text-orange-600 hover:underline text-sm block mt-1">
                        (800) MON-ARCH
                    </a>
                    <a href="mailto:compliance@monarchfinance.com" className="text-orange-600 hover:underline text-sm">
                        compliance@monarchfinance.com
                    </a>
                </div>
            </section>
